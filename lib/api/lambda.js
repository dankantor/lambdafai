...
/**
 * Routes S3 PUT requests for a given path to the handler. S3 paths will be of the form:
 * /bucket/key, and can include placeholders prefixed with a colon, e.g. `/my-items/:id`, which will
 * match all items in top level of bucket "my-items".
 * @param path {string} the path to register the handler at
 * @param handler {function} function with signature `function(req, res)` for handling the request
 */
