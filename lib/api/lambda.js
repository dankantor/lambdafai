...
Lambda.prototype.get = function(path, handler, authorizer) {
  ...
  if (authorizer) {
    this._addApiGatewayAuthorizerEvent('/GET' + path, authorizer);
  }
  return this;
};
...
Lambda.prototype.post = function(path, handler, authorizer) {
  ...
  if (authorizer) {
    this._addApiGatewayAuthorizerEvent('/POST' + path, authorizer);
  }
  return this;
};
...
Lambda.prototype.put = function(path, handler) {
  ...
  if (authorizer) {
    this._addApiGatewayAuthorizerEvent('/PUT' + path, authorizer);
  }
  return this;
};
...
Lambda.prototype.delete = function(path, handler) {
  ...
  if (authorizer) {
    this._addApiGatewayAuthorizerEvent('/DELETE' + path, authorizer);
  }
  return this;
};
...
Lambda.prototype.options = function(path, handler) {
  ...
  if (authorizer) {
    this._addApiGatewayAuthorizerEvent('/OPTIONS' + path, authorizer);
  }
  return this;
};
 ...
 * @param handler {function} function with signature `function(req, res)` for handling the request
 */
Lambda.prototype._addApiGatewayAuthorizerEvent = function(path, handler) {
