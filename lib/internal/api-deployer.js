  ...
  async.waterfall([
    ...
    function createResponses(next) {
      if (method === 'OPTIONS') {
        ...
        console.log('skipped putMethodResponse');
        next();
      }
    },
    ...
    function createIntegrationResponses(next) {
      if (method === 'OPTIONS') {
        ...
        console.log('skipped putIntegrationResponse');
        next();
      }
    },
    function updateResponses(next) {
      if (method === 'OPTIONS') {
        ...
        console.log('skipped updateMethodResponse');
        next();
      }
    },
    function updateIntegrationResponses(next) {
      if (method === 'OPTIONS') {
        ...
        console.log('skipped updateIntegrationResponse');
        next();
      }
    },
