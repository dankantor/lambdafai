...
module.exports = {
  ...
  configureParser: function(parser) {
    ...
    parser.addArgument([ '--source' ], {
      help: 'Set the source file(s) to use for deploying a zip lambda. Useful if pre-building a bundle',
    });
  },
  ...
  execute: function(app, args, callback) {
    ...
    async.waterfall([
      function deployLambda(next) {
        ...
        lambdaDeployer.deploy(args.environment, args.lambda, args.source, next);
      },
