...
var ENTRY_POINT_FILE = '../entry-point.js';
var ENTRY_POINT_PATH = 'lambdafai.js';
...
function buildZipFile() {
  ...
  // Add the Lambdafai entry point.
  var entry = fs.readFileSync(path.join(__dirname, ENTRY_POINT_FILE));
  zip.file(ENTRY_POINT_PATH, entry);
